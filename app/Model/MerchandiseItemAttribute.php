...
class MerchandiseItemAttribute extends Model
{
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'merchandise_id' => 'integer', 'item_id' => 'integer', 'attribute_id' => 'integer', 'state' => 'integer', 'created_at' => 'integer', 'updated_at' => 'integer', 'deleted_at' => 'integer'];
